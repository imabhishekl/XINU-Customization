...
void test_func7()
{
  ...
  {  
    *((int *)addrs[i]) = i + 1;
    //kprintf("<%d><%d>",*((int *)addrs[i]),((int *)addrs[i]));
...
/*  for(i = 0;i < NFRAMES;i++)
  {
     kprintf("\n<%d><%d><%d>",frm_tab[i].fr_type,i,frm_tab[i].fr_pid);
  }*/
